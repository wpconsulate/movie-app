...
function handleOnPress(id:number, navigation: NavigationScreenProp<NavigationRoute<NavigationParams>,NavigationParams>){
    console.log(id)
    navigation.push('Profile', {userId: id})
}
const image = "https://us.123rf.com/450wm/imagevectors/imagevectors1606/imagevectors160600227/58872995-white-profile-icon-on-blue-button-isolated-on-white.jpg?ver=6"
