...
function StatsKey(props:IProps){
    ...
    return(
        <View style={{flexDirection:"row", alignItems:"center"}}>
            ...
            <Text style={[{marginLeft:10, flex:3, fontFamily:"PoppinsMedium"  }, styles.text]}>{props.text} </Text>
...
export default class UserStats extends React.PureComponent {
    ...
    render() {
        ...
        const keys: Array<"Watching" | "Completed" | "Dropped" | "PlanToWatch">   = [ 'Watching', 'Completed', 'Dropped', 'PlanToWatch' ]
        return (
